...
// const updaters = ["System", "Alice", "Bob", "Charlie"];

// const users: User[] = Array.from({ length: 100 }, (_, i) => {
//   const role = roles[i % roles.length];
//   const lastUpdatedBy = updaters[i % updaters.length];
//   const now = new Date();
...
//     groups: [],
//     role, // new
//     lastLoggedOn: new Date(now.getTime() - i * 1000 * 60 * 60).toISOString(), // simulate variation
